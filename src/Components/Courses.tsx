...
const Courses: React.FC = () => {
    const programs = [
        ...
        },
        {
            ...
            instructors: '10 instructors',
            description: 'The app features in-app coding, eliminating the need for laptops. With cloud-based virtual machines and labs, students can practice freely, cutting hardware and maintenance costs.',
            imageUrl: 'https://s3-alpha-sig.figma.com/img/9da9/76fe/c6563fe5d5083b36f0ff6b230eb4dc18?Expires=1731888000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=h7sryKxBBN2aAEVhBVyqf7-amJ~WDek9gA4WMsp5-6MfN1Ck0~XE41Lz9Iv1ibx2mt96gRi4pqeIBIi3iwHqkp7KBovkfDtgRJXOxnW7up6T73UJHTypjZeT9INk1XDm7vkISZEsmqbtw0lNZd-l1rEQ~b29QpfSbcTKADJGT1ugi7eC0cBOfSmziS3u5ZaXmvPXVSUHlBYNT~NdSbq-66rNJIZ36PfnXaee-vLpAgvDyvuNk5BOkqjtiYl~qpb5OUAU4yJ46Tll3UWqvTtqbRdGQ85hKT9MyZy~fJnEigQzsdtwU1Ej6tXoyTF447R9zBZ9vJfDlMAp5KxKT62cNA__',
        },
    ];
